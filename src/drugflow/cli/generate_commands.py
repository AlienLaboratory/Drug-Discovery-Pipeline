...
def active_pick(ctx, input_path, model_path, output_path, strategy,
    ...
    if strategy == "greedy":
        from drugflow.phase3.active_learning.acquisition import greedy_acquisition
        selected = greedy_acquisition(dataset, model, batch_size)
    elif strategy == "uncertainty":
        from drugflow.phase3.active_learning.acquisition import uncertainty_acquisition
        selected = uncertainty_acquisition(dataset, model, batch_size)
    elif strategy == "ucb":
        from drugflow.phase3.active_learning.acquisition import ucb_acquisition
        selected = ucb_acquisition(dataset, model, batch_size, kappa=kappa)
    elif strategy == "diversity":
        from drugflow.phase3.active_learning.acquisition import diversity_acquisition
        selected = diversity_acquisition(dataset, batch_size)
    elif strategy == "balanced":
        from drugflow.phase3.active_learning.acquisition import balanced_acquisition
