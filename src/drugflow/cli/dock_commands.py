...
def shape_screen(ctx, input_path, ref_path, output_path, threshold, metric):
    ...
    from drugflow.phase1.data.loaders import load_file
    from drugflow.phase1.data.validators import validate_dataset
    from drugflow.phase4.shape_screening.shape_screen import screen_by_shape
...
def interactions(ctx, input_path, protein_path, output_path):
    ...
    if protein_path:
        from drugflow.phase4.docking.protein_prep import prepare_protein
        from drugflow.phase4.interactions.contacts import detect_all_contacts
        from drugflow.phase4.interactions.plif import compute_plif
...
def run(ctx, input_path, protein_path, center, size, exhaustiveness,
    ...
    from drugflow.phase1.data.loaders import load_file
    from drugflow.phase1.data.validators import validate_dataset
    from drugflow.phase4.docking.grid import define_grid_from_coords
