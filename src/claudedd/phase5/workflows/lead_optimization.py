...
from claudedd.phase5.reporting.export import export_project_json, export_results_csv
...
def run_lead_optimization(
    ...
    from claudedd.phase2.scoring.ranking import rank_molecules
    ...
    n_prepared = 0
    if top_candidates:
        from claudedd.phase4.ligand_prep.preparation import prepare_ligand
            ...
            if rec.mol is not None:
                try:
                    ...
                    if lead_3d is not None:
                        try:
                            from claudedd.phase4.shape_screening.scoring import compute_shape_tanimoto
