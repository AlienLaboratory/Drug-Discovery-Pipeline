...
from claudedd.phase3.generation.mutations import random_mutation
from claudedd.utils.chem import mol_to_smiles
...
def qsar_guided_ga(
    ...
    """
    from claudedd.phase1.analysis.descriptors import compute_descriptors
    from claudedd.phase1.analysis.fingerprints import compute_morgan
    from claudedd.phase2.qsar.prediction import predict_single
