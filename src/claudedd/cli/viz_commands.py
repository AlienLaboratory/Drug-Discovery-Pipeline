...
def structures(ctx, input_path, output, grid, cols, max_mols, label):
    ...
    from claudedd.phase1.visualization.structure import draw_molecule, draw_molecule_grid
...
def distributions(ctx, input_path, output, properties, plot_type, cols):
    ...
    from claudedd.phase1.data.validators import validate_dataset
    from claudedd.phase1.analysis.properties import compute_properties_dataset
    from claudedd.phase1.visualization.distributions import plot_property_distributions
...
def scatter(ctx, input_path, output, x, y, color):
    ...
    from claudedd.phase1.data.validators import validate_dataset
    from claudedd.phase1.analysis.properties import compute_properties_dataset
    from claudedd.phase1.visualization.distributions import plot_property_scatter
...
def chemical_space(ctx, input_path, output, method, fp_type, color, perplexity):
    ...
    from claudedd.phase1.visualization.chemical_space import (
...
def correlation(ctx, input_path, output, properties):
    ...
    from claudedd.phase1.data.validators import validate_dataset
    from claudedd.phase1.analysis.properties import compute_properties_dataset
    from claudedd.phase1.visualization.distributions import plot_property_correlation_matrix
