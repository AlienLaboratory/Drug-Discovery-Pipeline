...
def train(ctx, input_path, activity_col, model_type, task, model_path,
    ...
    from claudedd.phase2.qsar.evaluation import evaluate_model, cross_validate
    from claudedd.phase2.qsar.persistence import save_model
...
def evaluate(ctx, model_path, input_path, activity_col):
    ...
    from claudedd.phase2.qsar.evaluation import evaluate_model
